...
class Solution {
  ...
  // better solution not using set and just breaking after add number and pursue
  // to the next
  ...
  public List<Integer> findWordsContainingThird(String[] words, char x) {
    ArrayList<Integer> res = new ArrayList<Integer>();
    for (int i = 0; i < words.length; i++) {
      //getting char j looping using : and converting String to char array
